                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="store-location-select" class="form-select form-select-lg"
                            onchange="showSelectedLocation(this.value)">
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-4">
                                    <div>
                                        ...
                                        <p id="selected-location-type"
                                            class="text-muted small mb-0 text-uppercase fw-semibold"></p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="store-locations-dropdown__location-info mb-4">
                                            ...
                                            <!-- Phone -->
                                            <div id="phone-section" class="d-flex align-items-center mb-3"
                                            ...
                                            <!-- Email -->
                                            <div id="email-section" class="d-flex align-items-center mb-3"
                                                style="display: none !important;">
                                            ...
                                            <!-- Website -->
                                            <div id="website-section" class="d-flex align-items-center mb-3"
                                                style="display: none !important;">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- Service Hours -->
                                        <div id="service-hours-section" class="mb-4"
                                            style="display: none !important;">
