...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection assetable_id
     * @property Grid\Column|Collection assetable_type
     ...
     * @method Grid\Column|Collection assetable_id(string $label = null)
     * @method Grid\Column|Collection assetable_type(string $label = null)
     ...
     * @property Show\Field|Collection assetable_id
     * @property Show\Field|Collection assetable_type
     ...
     * @method Show\Field|Collection assetable_id(string $label = null)
     * @method Show\Field|Collection assetable_type(string $label = null)
