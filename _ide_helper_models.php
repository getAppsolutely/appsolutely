...
namespace App\Models{
     ...
     *
     * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem ancestorsAndSelf($id, array $columns = [])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem ancestorsOf($id, array $columns = [])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem applyNestedSetScope(?string $table = null)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem byMenu(int $menuId)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem countErrors()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem d()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem defaultOrder(string $dir = 'asc')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem descendantsAndSelf($id, array $columns = [])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem descendantsOf($id, array $columns = [], $andSelf = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem fixSubtree($root)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem fixTree($root = null)
     * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem getNodeData($id, $required = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem getPlainNodeData($id, $required = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem getTotalErrors()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem hasChildren()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem hasParent()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem isBroken()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem leaves(array $columns = [])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem makeGap(int $cut, int $height)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem moveNode($key, $position)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem newModelQuery()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem newQuery()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem orWhereAncestorOf(bool $id, bool $andSelf = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem orWhereDescendantOf($id)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem orWhereNodeBetween($values)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem orWhereNotDescendantOf($id)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem ordered(string $direction = 'asc')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem published(?\Carbon\Carbon $datetime = null)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem query()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem rebuildSubtree($root, array $data, $delete = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem rebuildTree(array $data, $delete = false, $root = null)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem reversed()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem root(array $columns = [])
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem status($value = null, $operator = null)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereAncestorOf($id, $andSelf = false, $boolean = 'and')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereAncestorOrSelf($id)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereCreatedAt($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereDescendantOf($id, $boolean = 'and', $not = false, $andSelf = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereDescendantOrSelf(string $id, string $boolean = 'and', string $not = false)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereExpiredAt($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIcon($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereId($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIsAfter($id, $boolean = 'and')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIsBefore($id, $boolean = 'and')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIsExternal($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIsLeaf()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereIsRoot()
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereLeft($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereMenuId($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereNodeBetween($values, $boolean = 'and', $not = false, $query = null)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereNotDescendantOf($id)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereParentId($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem wherePermissionKey($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem wherePublishedAt($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereRemark($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereRight($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereRoute($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereSetting($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereStatus($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereTarget($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereThumbnail($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereTitle($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereType($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem whereUpdatedAt($value)
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem withDepth(string $as = 'depth')
     * @method static \Kalnoy\Nestedset\QueryBuilder<static>|MenuItem withoutRoot()
     */
