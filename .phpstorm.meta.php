...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'appsolutely.local_timezone', 'appsolutely.time_format', 'appsolutely.currency.symbol', 'appsolutely.storage.dash_files', 'appsolutely.storage.assets',
        'appsolutely.storage.public', 'appsolutely.features.disabled', 'auth.defaults.guard', 'auth.defaults.passwords', 'auth.guards.web.driver',
        ...
        'auth.passwords.users.table', 'auth.passwords.users.expire', 'auth.passwords.users.throttle', 'auth.password_timeout', 'auth.enable',
        'auth.controller', 'auth.guard', 'auth.remember', 'auth.except', 'auth.enable_session_middleware',
        ...
        'filesystems.disks.s3.report', 'filesystems.disks.s3.prefix', 'filesystems.links./var/www/appsolute.ly/site/public/storage', 'fortify.guard', 'fortify.middleware',
        ...
        'jetstream.features', 'jetstream.profile_photo_disk', 'jetstream.auth_session', 'jetstream.guard', 'laravellocalization.supportedLocales.en.name',
        'laravellocalization.supportedLocales.en.script', 'laravellocalization.supportedLocales.en.native', 'laravellocalization.supportedLocales.en.regional', 'laravellocalization.supportedLocales.zh_CN.name', 'laravellocalization.supportedLocales.zh_CN.script',
        'laravellocalization.supportedLocales.zh_CN.native', 'laravellocalization.supportedLocales.zh_CN.regional', 'laravellocalization.supportedLocales.zh-TW.name', 'laravellocalization.supportedLocales.zh-TW.script', 'laravellocalization.supportedLocales.zh-TW.native',
        'laravellocalization.supportedLocales.zh-TW.regional', 'laravellocalization.useAcceptLanguageHeader', 'laravellocalization.hideDefaultLocaleInURL', 'laravellocalization.localesOrder', 'laravellocalization.localesMapping',
        ...
        'minify.directives.@', 'minify.keep_directives', 'openai.api_key', 'openai.organization', 'openai.request_timeout',
        ...
        'queue.failed.driver', 'queue.failed.database', 'queue.failed.table', 'repository.pagination.limit', 'repository.fractal.params.include',
        'repository.fractal.serializer', 'repository.cache.enabled', 'repository.cache.minutes', 'repository.cache.repository', 'repository.cache.clean.enabled',
        'repository.cache.clean.on.create', 'repository.cache.clean.on.update', 'repository.cache.clean.on.delete', 'repository.cache.params.skipCache', 'repository.cache.allowed.only',
        'repository.cache.allowed.except', 'repository.criteria.acceptedConditions', 'repository.criteria.params.search', 'repository.criteria.params.searchFields', 'repository.criteria.params.filter',
        'repository.criteria.params.orderBy', 'repository.criteria.params.sortedBy', 'repository.criteria.params.with', 'repository.criteria.params.searchJoin', 'repository.criteria.params.withCount',
        'repository.generator.basePath', 'repository.generator.rootNamespace', 'repository.generator.stubsOverridePath', 'repository.generator.paths.models', 'repository.generator.paths.repositories',
        'repository.generator.paths.interfaces', 'repository.generator.paths.transformers', 'repository.generator.paths.presenters', 'repository.generator.paths.validators', 'repository.generator.paths.controllers',
        'repository.generator.paths.provider', 'repository.generator.paths.criteria', 'sanctum.stateful', 'sanctum.guard', 'sanctum.expiration',
        ...
        'services.slack.notifications.channel', 'services.translation.provider', 'services.translation.openai.api_key', 'services.translation.openai.model', 'services.translation.openai.max_tokens',
        'services.translation.openai.temperature', 'services.translation.deepseek.api_key', 'services.translation.deepseek.model', 'services.translation.deepseek.max_tokens', 'services.translation.deepseek.temperature',
        ...
        'session.partitioned', 'theme.active', 'theme.parent', 'theme.base_path', 'hashing.driver',
        ...
        'livewire.inject_morph_markers', 'livewire.pagination_theme', 'eloquent-sortable.order_column_name', 'eloquent-sortable.sort_when_creating', 'eloquent-sortable.ignore_timestamps',
    ...
    registerArgumentsSet('routes',
        ...
        'dcat.admin.', 'dcat.admin.', 'dcat.admin.', 'dcat.admin.file.self', 'dcat.admin.articles.index',
        'dcat.admin.articles.create', 'dcat.admin.articles.store', 'dcat.admin.articles.show', 'dcat.admin.articles.edit', 'dcat.admin.articles.update',
        'dcat.admin.articles.destroy', 'dcat.admin.article.categories.index', 'dcat.admin.article.categories.create', 'dcat.admin.article.categories.store', 'dcat.admin.article.categories.show',
        'dcat.admin.article.categories.edit', 'dcat.admin.article.categories.update', 'dcat.admin.article.categories.destroy', 'dcat.admin.pages.index', 'dcat.admin.pages.create',
        'dcat.admin.pages.store', 'dcat.admin.pages.show', 'dcat.admin.pages.edit', 'dcat.admin.pages.update', 'dcat.admin.pages.destroy',
        'dcat.admin.files.manager.index', 'dcat.admin.files.manager.create', 'dcat.admin.files.manager.store', 'dcat.admin.files.manager.show', 'dcat.admin.files.manager.edit',
        'dcat.admin.files.manager.update', 'dcat.admin.files.manager.destroy', 'dcat.admin.pages.design', 'dcat.admin.products.index', 'dcat.admin.products.create',
        'dcat.admin.products.store', 'dcat.admin.products.show', 'dcat.admin.products.edit', 'dcat.admin.products.update', 'dcat.admin.products.destroy',
        'dcat.admin.product.categories.index', 'dcat.admin.product.categories.create', 'dcat.admin.product.categories.store', 'dcat.admin.product.categories.show', 'dcat.admin.product.categories.edit',
        'dcat.admin.product.categories.update', 'dcat.admin.product.categories.destroy', 'dcat.admin.product.skus.index', 'dcat.admin.product.skus.create', 'dcat.admin.product.skus.store',
        'dcat.admin.product.skus.show', 'dcat.admin.product.skus.edit', 'dcat.admin.product.skus.update', 'dcat.admin.product.skus.destroy', 'dcat.admin.orders.index',
        'dcat.admin.orders.create', 'dcat.admin.orders.store', 'dcat.admin.orders.show', 'dcat.admin.orders.edit', 'dcat.admin.orders.update',
        'dcat.admin.orders.destroy', 'dcat.admin.attribute.groups.index', 'dcat.admin.attribute.groups.create', 'dcat.admin.attribute.groups.store', 'dcat.admin.attribute.groups.show',
        'dcat.admin.attribute.groups.edit', 'dcat.admin.attribute.groups.update', 'dcat.admin.attribute.groups.destroy', 'dcat.admin.attributes.index', 'dcat.admin.attributes.create',
        'dcat.admin.attributes.store', 'dcat.admin.attributes.show', 'dcat.admin.attributes.edit', 'dcat.admin.attributes.update', 'dcat.admin.attributes.destroy',
        'dcat.admin.attribute.values.index', 'dcat.admin.attribute.values.create', 'dcat.admin.attribute.values.store', 'dcat.admin.attribute.values.show', 'dcat.admin.attribute.values.edit',
        'dcat.admin.attribute.values.update', 'dcat.admin.attribute.values.destroy', 'dcat.admin.app.builds.index', 'dcat.admin.app.builds.create', 'dcat.admin.app.builds.store',
        'dcat.admin.app.builds.show', 'dcat.admin.app.builds.edit', 'dcat.admin.app.builds.update', 'dcat.admin.app.builds.destroy', 'dcat.admin.app.versions.index',
        'dcat.admin.app.versions.create', 'dcat.admin.app.versions.store', 'dcat.admin.app.versions.show', 'dcat.admin.app.versions.edit', 'dcat.admin.app.versions.update',
        'dcat.admin.app.versions.destroy', 'dcat.admin.api.files.library', 'dcat.admin.api.common.quick-edit', 'dcat.admin.api.attribute.groups', 'dcat.admin.api.api.pages.data',
        'dcat.admin.api.api.pages.save', 'dcat.admin.api.api.components.registry', 'minify.assets', 'dcat.admin.', 'dcat.admin.',
        ...
        'file.public.storage', 'dashboard', 'member.register', 'member.', 'member.login',
        'member.', 'member.password.request', 'member.password.email', 'member.password.reset', 'member.password.update',
        'member.verification.notice', 'member.verification.verify', 'member.verification.send', 'member.password.confirm', 'member.',
        'member.logout', 'routes', 'routes', 'pages.show', 'storage.local', );
    registerArgumentsSet('views',
        ...
        'layouts.guest', 'navigation-menu', 'page-builder::index', 'pages.show', 'policy',
        ...
        'teams.team-member-manager', 'teams.update-team-name-form', 'terms', 'admin::dashboard.dependencies', 'admin::dashboard.environment',
    ...
    registerArgumentsSet('translations',
        ...
        'admin.uploader.confirm_delete_file', 'admin.uploader.dimensions', 'admin.import_extension_confirm', 'admin.quick_create', 'admin.grid_items_selected',
        'admin.nothing_updated', 'admin.welcome_back', 'admin.documentation', 'admin.demo', 'admin.extensions',
        'admin.version', 'admin.current_version', 'admin.latest_version', 'admin.upgrade_to_version', 'admin.enable',
        'admin.disable', 'admin.uninstall', 'admin.confirm_uninstall', 'admin.marketplace', 'admin.theme',
        'admin.application', 'admin.install_from_local', 'admin.install_succeeded', 'admin.invalid_extension_package', 'admin.copied',
        'admin.auth_failed', 'admin.validation.match', 'admin.validation.minlength', 'admin.validation.maxlength', 'admin.client.submit',
        'admin.home', 'extension.labels.Extensions', 'extension.fields.alias', 'extension.fields.description', 'extension.fields.authors',
        'extension.fields.homepage', 'extension.fields.require', 'extension.fields.require_dev', 'extension.fields.name', 'extension.fields.version',
        'extension.fields.enable', 'extension.fields.config', 'extension.fields.imported', 'global.fields.id', 'global.fields.name',
        'global.fields.username', 'global.fields.email', 'global.fields.http_path', 'global.fields.password', 'global.fields.password_confirmation',
        'global.fields.created_at', 'global.fields.updated_at', 'global.fields.permissions', 'global.fields.slug', 'global.fields.user',
        'global.fields.order', 'global.fields.ip', 'global.fields.method', 'global.fields.uri', 'global.fields.roles',
        'global.fields.path', 'global.fields.input', 'global.fields.type', 'global.labels.list', 'global.labels.edit',
        'global.labels.detail', 'global.labels.create', 'global.labels.root', 'global.labels.scaffold', 'menu.titles.index',
        'menu.titles.admin', 'menu.titles.users', 'menu.titles.roles', 'menu.titles.permission', 'menu.titles.menu',
        'menu.titles.operation_log', 'menu.titles.helpers', 'menu.titles.extensions', 'menu.titles.scaffold', 'menu.titles.icons',
        'ghost.dcat-config::dcat-config.title', 'ghost.dcat-config::dcat-config.description', 'ghost.dcat-config::dcat-config.grid.key', 'ghost.dcat-config::dcat-config.grid.name', 'ghost.dcat-config::dcat-config.builder.config',
        'ghost.dcat-config::dcat-config.builder.groups', 'ghost.dcat-config::dcat-config.builder.attribute', 'ghost.dcat-config::dcat-config.builder.key', 'ghost.dcat-config::dcat-config.builder.name', 'ghost.dcat-config::dcat-config.builder.help',
        'ghost.dcat-config::dcat-config.builder.element', 'ghost.dcat-config::dcat-config.builder.option', 'ghost.dcat-config::dcat-config.builder.rule', 'ghost.dcat-config::dcat-config.builder.key-help', 'ghost.dcat-config::dcat-config.builder.option-help',
        'ghost.dcat-config::dcat-config.builder.rule-help', 'ghost.dcat-config::dcat-config.builder.key-existed', 'ghost.dcat-config::dcat-config.builder.key-required', 'ghost.dcat-config::dcat-config.builder.key-regex', 'ghost.dcat-config::dcat-config.builder.name-required',
        'ghost.dcat-config::dcat-config.builder.element-required', 'ghost.dcat-config::dcat-config.builder.groups-required', 'ghost.dcat-config::dcat-config.Option.Text', 'ghost.dcat-config::dcat-config.Option.Select', 'ghost.dcat-config::dcat-config.Option.MultipleSelect',
        'ghost.dcat-config::dcat-config.Option.ListBox', 'ghost.dcat-config::dcat-config.Option.Textarea', 'ghost.dcat-config::dcat-config.Option.Radio', 'ghost.dcat-config::dcat-config.Option.CheckBox', 'ghost.dcat-config::dcat-config.Option.E-mail',
        'ghost.dcat-config::dcat-config.Option.PassWord', 'ghost.dcat-config::dcat-config.Option.Url', 'ghost.dcat-config::dcat-config.Option.IP', 'ghost.dcat-config::dcat-config.Option.Mobile', 'ghost.dcat-config::dcat-config.Option.Color',
        'ghost.dcat-config::dcat-config.Option.Time', 'ghost.dcat-config::dcat-config.Option.Date', 'ghost.dcat-config::dcat-config.Option.DateTime', 'ghost.dcat-config::dcat-config.Option.File', 'ghost.dcat-config::dcat-config.Option.Image',
        'ghost.dcat-config::dcat-config.Option.MultipleImage', 'ghost.dcat-config::dcat-config.Option.MultipleFile', 'ghost.dcat-config::dcat-config.Option.Editor', 'ghost.dcat-config::dcat-config.Option.Number', 'ghost.dcat-config::dcat-config.Option.Rate',
        'ghost.dcat-config::dcat-config.Option.Arrays', 'repository::criteria.fields_not_accepted', 'repository::packages.prettus_laravel_validation_required', 'repository::packages.league_fractal_required', );
    registerArgumentsSet('env',
        ...
        'AWS_PREFIX', 'VITE_APP_NAME', 'MINIFY_ENABLED', 'LOCAL_TIMEZONE', 'ADMIN_ROUTE_DOMAIN',
        'ADMIN_ROUTE_PREFIX', 'TRANSLATION_PROVIDER', 'TRANSLATION_JOB_LIMIT', 'AUTO_TRANSLATION_ENABLED', 'OPENAI_API_KEY',
        'OPENAI_MODEL', 'DEEPSEEK_API_KEY', 'DEEPSEEK_MODEL', 'DEBUGBAR_REMOTE_SITES_PATH', 'DEBUGBAR_LOCAL_SITES_PATH',
        'APPSOLUTELY_URL', 'VITE_DEV_SERVER_URL', 'DISABLED_FEATURES', );
