...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'app.aliases.Validator', 'app.aliases.View', 'app.aliases.Vite', 'appsolutely.timezone', 'appsolutely.prefix',
        ...
        'laravellocalization.supportedLocales.en.regional', 'laravellocalization.supportedLocales.zh.name', 'laravellocalization.supportedLocales.zh.script', 'laravellocalization.supportedLocales.zh.native', 'laravellocalization.supportedLocales.zh.regional',
    ...
    registerArgumentsSet('routes',
        ...
        'dcat.admin.', 'dcat.admin.', 'dcat.admin.', 'dcat.admin.files.manager.index', 'dcat.admin.files.manager.create',
        'dcat.admin.files.manager.store', 'dcat.admin.files.manager.show', 'dcat.admin.files.manager.edit', 'dcat.admin.files.manager.update', 'dcat.admin.files.manager.destroy',
        'dcat.admin.article_categories.index', 'dcat.admin.article_categories.create', 'dcat.admin.article_categories.store', 'dcat.admin.article_categories.show', 'dcat.admin.article_categories.edit',
        'dcat.admin.article_categories.update', 'dcat.admin.article_categories.destroy', 'dcat.admin.articles.index', 'dcat.admin.articles.create', 'dcat.admin.articles.store',
        'dcat.admin.articles.show', 'dcat.admin.articles.edit', 'dcat.admin.articles.update', 'dcat.admin.articles.destroy', 'minify.assets',
        'dcat.admin.', 'dcat.admin.', 'dcat.admin.', 'dcat.admin.', 'dcat.admin.file.upload',
    ...
    registerArgumentsSet('translations',
        ...
        'ghost.dcat-config::dcat-config.Option.Arrays', );
