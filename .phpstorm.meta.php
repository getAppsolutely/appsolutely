...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'appsolutely.local_timezone', 'appsolutely.time_format', 'appsolutely.asset', 'appsolutely.theme.name', 'appsolutely.theme.styles',
    ...
    registerArgumentsSet('routes',
        ...
        'two-factor.qr-code', 'two-factor.secret-key', 'two-factor.recovery-codes', 'terms.show',
        'policy.show', 'profile.show', 'api-tokens.index', 'teams.create', 'teams.show',
        'current-team.update', 'team-invitations.accept', 'sanctum.csrf-cookie', 'livewire.update', 'livewire.upload-file', 'livewire.preview-file', 'file.public.assets', 'book', 'file.public.storage', 'dashboard',
        'member.register', 'member.', 'member.login', 'member.', 'member.password.request',
        'member.password.email', 'member.password.reset', 'member.password.update', 'member.verification.notice', 'member.verification.verify',
        'member.verification.send', 'member.password.confirm', 'member.', 'member.logout', 'routes',
        'routes', 'home', 'pages.show', 'storage.local', );
    registerArgumentsSet('views',
        ...
        'livewire.testimonial', 'livewire.testimonial', 'livewire.transition-section', 'livewire.transition-section', 'livewire.video-showcase',
        'livewire.video-showcase', 'navigation-menu', 'page-builder::grapes', 'page-builder::index', 'pages.show',
        ...
        'teams.show', 'teams.team-member-manager', 'teams.update-team-name-form', 'terms', 'admin::dashboard.dependencies',
        'admin::dashboard.environment', 'admin::dashboard.extensions', 'admin::dashboard.title', 'admin::filter.between', 'admin::filter.between-datetime',
        'admin::filter.button', 'admin::filter.checkbox', 'admin::filter.container', 'admin::filter.datetime', 'admin::filter.gt',
        'admin::filter.lt', 'admin::filter.multipleselect', 'admin::filter.radio', 'admin::filter.right-side-container', 'admin::filter.select',
        'admin::filter.selecttable', 'admin::filter.simple-container', 'admin::filter.text', 'admin::filter.where', 'admin::form.autocomplete',
        'admin::form.button', 'admin::form.captcha', 'admin::form.checkbox', 'admin::form.color', 'admin::form.container',
        'admin::form.daterange', 'admin::form.datetimerange', 'admin::form.display', 'admin::form.editor', 'admin::form.embeds',
        'admin::form.error', 'admin::form.fields', 'admin::form.file', 'admin::form.footer', 'admin::form.hasmany',
        'admin::form.hasmanytab', 'admin::form.hasmanytable', 'admin::form.help-block', 'admin::form.hidden', 'admin::form.id',
        'admin::form.input', 'admin::form.keyvalue', 'admin::form.listbox', 'admin::form.listfield', 'admin::form.map',
        'admin::form.markdown', 'admin::form.multipleselect', 'admin::form.number', 'admin::form.radio', 'admin::form.range',
        'admin::form.rate', 'admin::form.row', 'admin::form.select', 'admin::form.select-script', 'admin::form.selecttable',
        'admin::form.slider', 'admin::form.switchfield', 'admin::form.tab', 'admin::form.tags', 'admin::form.textarea',
        'admin::form.timerange', 'admin::form.tree', 'admin::grid.async-fixed-table', 'admin::grid.async-table', 'admin::grid.batch-actions',
        'admin::grid.column-selector', 'admin::grid.displayer.dialogtree', 'admin::grid.displayer.editinline.checkbox', 'admin::grid.displayer.editinline.input', 'admin::grid.displayer.editinline.radio',
        'admin::grid.displayer.editinline.template', 'admin::grid.displayer.editinline.textarea', 'admin::grid.displayer.expand', 'admin::grid.displayer.extensions.description', 'admin::grid.displayer.extensions.name',
        'admin::grid.displayer.select', 'admin::grid.displayer.switch', 'admin::grid.displayer.switchgroup', 'admin::grid.displayer.table', 'admin::grid.dropdown-actions',
        'admin::grid.fixed-table', 'admin::grid.image', 'admin::grid.pagination', 'admin::grid.quick-create.date', 'admin::grid.quick-create.form',
        'admin::grid.quick-create.multipleselect', 'admin::grid.quick-create.select', 'admin::grid.quick-create.selectresource', 'admin::grid.quick-create.tags', 'admin::grid.quick-create.text',
        'admin::grid.quick-search', 'admin::grid.selector', 'admin::grid.table', 'admin::grid.table-pagination', 'admin::grid.table-toolbar',
        'admin::helpers.feather', 'admin::helpers.font-awesome', 'admin::helpers.scaffold', 'admin::layouts.container', 'admin::layouts.content',
        'admin::layouts.form-content', 'admin::layouts.full-content', 'admin::layouts.full-page', 'admin::layouts.page', 'admin::pages.login',
        'admin::partials.alerts', 'admin::partials.breadcrumb', 'admin::partials.exception', 'admin::partials.menu', 'admin::partials.navbar',
        'admin::partials.navbar-user-panel', 'admin::partials.sidebar', 'admin::partials.sidebar-user-panel', 'admin::partials.toastr', 'admin::scripts.select',
        'admin::show.container', 'admin::show.field', 'admin::show.panel', 'admin::show.row', 'admin::tree.branch',
        'admin::tree.container', 'admin::widgets.alert', 'admin::widgets.box', 'admin::widgets.card', 'admin::widgets.checkbox',
        'admin::widgets.data-card', 'admin::widgets.data-card.chart', 'admin::widgets.data-card.line-chart', 'admin::widgets.dialogtable', 'admin::widgets.dropdown',
        'admin::widgets.form', 'admin::widgets.markdown', 'admin::widgets.metrics.card', 'admin::widgets.radio', 'admin::widgets.tab',
        'admin::widgets.table', 'admin::widgets.tree', 'ghost.dcat-config::tree', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context',
    ...
    registerArgumentsSet('translations',
        ...
        'validation.uuid', 'validation.custom.attribute-name.rule-name', 'admin.scaffold.header', 'admin.scaffold.choose', 'admin.scaffold.table',
        'admin.scaffold.model', 'admin.scaffold.controller', 'admin.scaffold.repository', 'admin.scaffold.add_field', 'admin.scaffold.pk',
        'admin.scaffold.soft_delete', 'admin.scaffold.create_migration', 'admin.scaffold.create_model', 'admin.scaffold.create_repository', 'admin.scaffold.create_controller',
        'admin.scaffold.run_migrate', 'admin.scaffold.create_lang', 'admin.scaffold.field', 'admin.scaffold.translation', 'admin.scaffold.comment',
        'admin.scaffold.default', 'admin.scaffold.field_name', 'admin.scaffold.type', 'admin.scaffold.nullable', 'admin.scaffold.key',
        'admin.scaffold.translate_title', 'admin.scaffold.sync_translation_with_comment', 'admin.client.delete_confirm', 'admin.client.confirm', 'admin.client.cancel',
        'admin.client.refresh_succeeded', 'admin.client.close', 'admin.client.selected_options', 'admin.client.exceed_max_item', 'admin.client.no_preview',
        'admin.client.500', 'admin.client.403', 'admin.client.401', 'admin.client.419', 'admin.online',
        'admin.login', 'admin.logout', 'admin.setting', 'admin.name', 'admin.username',
        'admin.user', 'admin.alias', 'admin.routes', 'admin.route_action', 'admin.middleware',
        'admin.method', 'admin.old_password', 'admin.password', 'admin.password_confirmation', 'admin.old_password_error',
        'admin.remember_me', 'admin.user_setting', 'admin.avatar', 'admin.list', 'admin.new',
        'admin.create', 'admin.delete', 'admin.remove', 'admin.edit', 'admin.quick_edit',
        'admin.view', 'admin.continue_editing', 'admin.continue_creating', 'admin.detail', 'admin.browse',
        'admin.reset', 'admin.export', 'admin.batch_delete', 'admin.save', 'admin.refresh',
        'admin.order', 'admin.expand', 'admin.collapse', 'admin.filter', 'admin.search',
        'admin.close', 'admin.show', 'admin.entries', 'admin.captcha', 'admin.action',
        'admin.title', 'admin.description', 'admin.back', 'admin.back_to_list', 'admin.submit',
        'admin.menu', 'admin.input', 'admin.succeeded', 'admin.failed', 'admin.delete_confirm',
        'admin.delete_succeeded', 'admin.delete_failed', 'admin.update_succeeded', 'admin.update_failed', 'admin.save_succeeded',
        'admin.save_failed', 'admin.refresh_succeeded', 'admin.login_successful', 'admin.choose', 'admin.choose_file',
        'admin.choose_image', 'admin.more', 'admin.deny', 'admin.administrator', 'admin.no_data',
        'admin.roles', 'admin.permissions', 'admin.slug', 'admin.created_at', 'admin.updated_at',
        'admin.alert', 'admin.parent_id', 'admin.icon', 'admin.uri', 'admin.operation_log',
        'admin.parent_select_error', 'admin.tree', 'admin.table', 'admin.default', 'admin.import',
        'admin.is_not_import', 'admin.selected_options', 'admin.pagination.range', 'admin.role', 'admin.permission',
        'admin.route', 'admin.confirm', 'admin.cancel', 'admin.selectall', 'admin.http.method',
        'admin.http.path', 'admin.all_methods_if_empty', 'admin.all', 'admin.current_page', 'admin.selected_rows',
        'admin.upload', 'admin.new_folder', 'admin.time', 'admin.size', 'admin.between_start',
        'admin.between_end', 'admin.next_page', 'admin.prev_page', 'admin.next_step', 'admin.prev_step',
        'admin.done', 'admin.listbox.text_total', 'admin.listbox.text_empty', 'admin.listbox.filtered', 'admin.listbox.filter_clear',
        'admin.listbox.filter_placeholder', 'admin.responsive.display_all', 'admin.responsive.display', 'admin.responsive.focus', 'admin.uploader.add_new_media',
        'admin.uploader.drag_file', 'admin.uploader.max_file_limit', 'admin.uploader.exceed_size', 'admin.uploader.interrupt', 'admin.uploader.upload_failed',
        'admin.uploader.selected_files', 'admin.uploader.selected_has_failed', 'admin.uploader.selected_success', 'admin.uploader.dot', 'admin.uploader.failed_num',
        'admin.uploader.pause_upload', 'admin.uploader.go_on_upload', 'admin.uploader.start_upload', 'admin.uploader.upload_success_message', 'admin.uploader.go_on_add',
        'admin.uploader.Q_TYPE_DENIED', 'admin.uploader.Q_EXCEED_NUM_LIMIT', 'admin.uploader.F_EXCEED_SIZE', 'admin.uploader.Q_EXCEED_SIZE_LIMIT', 'admin.uploader.F_DUPLICATE',
        'admin.uploader.confirm_delete_file', 'admin.uploader.dimensions', 'admin.import_extension_confirm', 'admin.quick_create', 'admin.form_help.expired_at_timezone',
        'admin.form_help.internal_reference', 'admin.form_help.name_fallback_title', 'admin.form_help.optional_field', 'admin.form_help.published_at_timezone', 'admin.form_help.required_field',
        'admin.form_help.slug_auto_generate', 'admin.grid_items_selected', 'admin.nothing_updated', 'admin.welcome_back', 'admin.documentation',
        'admin.demo', 'admin.extensions', 'admin.version', 'admin.current_version', 'admin.latest_version',
        'admin.upgrade_to_version', 'admin.enable', 'admin.disable', 'admin.uninstall', 'admin.confirm_uninstall',
        'admin.marketplace', 'admin.theme', 'admin.application', 'admin.install_from_local', 'admin.install_succeeded',
        'admin.invalid_extension_package', 'admin.copied', 'admin.auth_failed', 'admin.validation.match', 'admin.validation.minlength',
        'admin.validation.maxlength', 'admin.client.submit', 'admin.home', 'extension.labels.Extensions', 'extension.fields.alias',
        'extension.fields.description', 'extension.fields.authors', 'extension.fields.homepage', 'extension.fields.require', 'extension.fields.require_dev',
        'extension.fields.name', 'extension.fields.version', 'extension.fields.enable', 'extension.fields.config', 'extension.fields.imported',
        'global.fields.id', 'global.fields.name', 'global.fields.username', 'global.fields.email', 'global.fields.http_path',
        'global.fields.password', 'global.fields.password_confirmation', 'global.fields.created_at', 'global.fields.updated_at', 'global.fields.permissions',
        'global.fields.slug', 'global.fields.user', 'global.fields.order', 'global.fields.ip', 'global.fields.method',
        'global.fields.uri', 'global.fields.roles', 'global.fields.path', 'global.fields.input', 'global.fields.type',
        'global.labels.list', 'global.labels.edit', 'global.labels.detail', 'global.labels.create', 'global.labels.root',
        'global.labels.scaffold', 'menu.titles.index', 'menu.titles.admin', 'menu.titles.users', 'menu.titles.roles',
        'menu.titles.permission', 'menu.titles.menu', 'menu.titles.operation_log', 'menu.titles.helpers', 'menu.titles.extensions',
        'menu.titles.scaffold', 'menu.titles.icons', 'ghost.dcat-config::dcat-config.title', 'ghost.dcat-config::dcat-config.description', 'ghost.dcat-config::dcat-config.grid.key',
        'ghost.dcat-config::dcat-config.grid.name', 'ghost.dcat-config::dcat-config.builder.config', 'ghost.dcat-config::dcat-config.builder.groups', 'ghost.dcat-config::dcat-config.builder.attribute', 'ghost.dcat-config::dcat-config.builder.key',
        'ghost.dcat-config::dcat-config.builder.name', 'ghost.dcat-config::dcat-config.builder.help', 'ghost.dcat-config::dcat-config.builder.element', 'ghost.dcat-config::dcat-config.builder.option', 'ghost.dcat-config::dcat-config.builder.rule',
        'ghost.dcat-config::dcat-config.builder.key-help', 'ghost.dcat-config::dcat-config.builder.option-help', 'ghost.dcat-config::dcat-config.builder.rule-help', 'ghost.dcat-config::dcat-config.builder.key-existed', 'ghost.dcat-config::dcat-config.builder.key-required',
        'ghost.dcat-config::dcat-config.builder.key-regex', 'ghost.dcat-config::dcat-config.builder.name-required', 'ghost.dcat-config::dcat-config.builder.element-required', 'ghost.dcat-config::dcat-config.builder.groups-required', 'ghost.dcat-config::dcat-config.Option.Text',
        'ghost.dcat-config::dcat-config.Option.Select', 'ghost.dcat-config::dcat-config.Option.MultipleSelect', 'ghost.dcat-config::dcat-config.Option.ListBox', 'ghost.dcat-config::dcat-config.Option.Textarea', 'ghost.dcat-config::dcat-config.Option.Radio',
        'ghost.dcat-config::dcat-config.Option.CheckBox', 'ghost.dcat-config::dcat-config.Option.E-mail', 'ghost.dcat-config::dcat-config.Option.PassWord', 'ghost.dcat-config::dcat-config.Option.Url', 'ghost.dcat-config::dcat-config.Option.IP',
        'ghost.dcat-config::dcat-config.Option.Mobile', 'ghost.dcat-config::dcat-config.Option.Color', 'ghost.dcat-config::dcat-config.Option.Time', 'ghost.dcat-config::dcat-config.Option.Date', 'ghost.dcat-config::dcat-config.Option.DateTime',
        'ghost.dcat-config::dcat-config.Option.File', 'ghost.dcat-config::dcat-config.Option.Image', 'ghost.dcat-config::dcat-config.Option.MultipleImage', 'ghost.dcat-config::dcat-config.Option.MultipleFile', 'ghost.dcat-config::dcat-config.Option.Editor',
        'ghost.dcat-config::dcat-config.Option.Number', 'ghost.dcat-config::dcat-config.Option.Rate', 'ghost.dcat-config::dcat-config.Option.Arrays', 'repository::criteria.fields_not_accepted', 'repository::packages.prettus_laravel_validation_required',
        'repository::packages.league_fractal_required', );
    registerArgumentsSet('env',
        ...
        'APPSOLUTELY_URL', 'APPSOLUTELY_LOCAL_TIMEZONE', 'APPSOLUTELY_THEME', 'APPSOLUTELY_ENABLED_FEATURES', 'APPSOLUTELY_DISABLED_FEATURES', );
