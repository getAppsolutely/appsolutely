...
'auth.enable','auth.controller','auth.guard','auth.remember','auth.except',
'auth.enable_session_middleware','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'minify.enable_directive_replacement','minify.directives.@','minify.keep_directives','queue.default','queue.connections.sync.driver',
...
'eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'dcat.admin.','dcat.admin.','dcat.admin.','minify.assets','login',
...
'teams.show','current-team.update','team-invitations.accept','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','dashboard','storage.local',);
...
'terms','upload','welcome','admin::dashboard.dependencies','admin::dashboard.environment',
...
'admin::widgets.tree','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MINIFY_ENABLED',);
