...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'minify.ignore', 'minify.enable_directive_replacement', 'minify.directives.@', 'minify.keep_directives', 'openai.api_key',
        ...
        'services.ses.region', 'services.slack.notifications.bot_user_oauth_token', 'services.slack.notifications.channel', 'services.translation.provider', 'services.translation.openai.api_key',
        'services.translation.openai.model', 'services.translation.openai.max_tokens', 'services.translation.openai.temperature', 'services.translation.deepseek.api_key', 'services.translation.deepseek.model',
        'services.translation.deepseek.max_tokens', 'services.translation.deepseek.temperature', 'session.driver', 'session.lifetime', 'session.expire_on_close',
        ...
        'session.http_only', 'session.same_site', 'session.partitioned', 'theme.active', 'theme.parent',
        'theme.base_path', 'hashing.driver', 'hashing.bcrypt.rounds', 'hashing.bcrypt.verify', 'hashing.bcrypt.limit',
        ...
        'cors.supports_credentials', 'eloquent-sortable.order_column_name', 'eloquent-sortable.sort_when_creating', 'eloquent-sortable.ignore_timestamps', 'tinker.commands',
    ...
    registerArgumentsSet('routes',
        ...
        'dcat.admin.menus.entry.destroy', 'dcat.admin.products.entry.index', 'dcat.admin.products.entry.create', 'dcat.admin.products.entry.store', 'dcat.admin.products.entry.show',
        'dcat.admin.products.entry.edit', 'dcat.admin.products.entry.update', 'dcat.admin.products.entry.destroy', 'dcat.admin.products.categories.index', 'dcat.admin.products.categories.create',
        'dcat.admin.products.categories.store', 'dcat.admin.products.categories.show', 'dcat.admin.products.categories.edit', 'dcat.admin.products.categories.update', 'dcat.admin.products.categories.destroy',
        'dcat.admin.products.skus.index', 'dcat.admin.products.skus.create', 'dcat.admin.products.skus.store', 'dcat.admin.products.skus.show', 'dcat.admin.products.skus.edit',
        'dcat.admin.products.skus.update', 'dcat.admin.products.skus.destroy', 'dcat.admin.products.attribute-groups.index', 'dcat.admin.products.attribute-groups.create', 'dcat.admin.products.attribute-groups.store',
        'dcat.admin.products.attribute-groups.show', 'dcat.admin.products.attribute-groups.edit', 'dcat.admin.products.attribute-groups.update', 'dcat.admin.products.attribute-groups.destroy', 'dcat.admin.products.attributes.index',
        'dcat.admin.products.attributes.create', 'dcat.admin.products.attributes.store', 'dcat.admin.products.attributes.show', 'dcat.admin.products.attributes.edit', 'dcat.admin.products.attributes.update',
        'dcat.admin.products.attributes.destroy', 'dcat.admin.products.attribute-values.index', 'dcat.admin.products.attribute-values.create', 'dcat.admin.products.attribute-values.store', 'dcat.admin.products.attribute-values.show',
        'dcat.admin.products.attribute-values.edit', 'dcat.admin.products.attribute-values.update', 'dcat.admin.products.attribute-values.destroy', 'dcat.admin.orders.entry.index', 'dcat.admin.orders.entry.create',
        'dcat.admin.orders.entry.store', 'dcat.admin.orders.entry.show', 'dcat.admin.orders.entry.edit', 'dcat.admin.orders.entry.update', 'dcat.admin.orders.entry.destroy',
        'dcat.admin.releases.builds.index', 'dcat.admin.releases.builds.create', 'dcat.admin.releases.builds.store', 'dcat.admin.releases.builds.show', 'dcat.admin.releases.builds.edit',
        'dcat.admin.releases.builds.update', 'dcat.admin.releases.builds.destroy', 'dcat.admin.releases.versions.index', 'dcat.admin.releases.versions.create', 'dcat.admin.releases.versions.store',
        'dcat.admin.releases.versions.show', 'dcat.admin.releases.versions.edit', 'dcat.admin.releases.versions.update', 'dcat.admin.releases.versions.destroy', 'dcat.admin.api.file-library',
        'dcat.admin.api.common.quick-edit', 'dcat.admin.api.attribute-groups', 'dcat.admin.api.pages.data', 'dcat.admin.api.pages.save', 'dcat.admin.api.pages.reset',
        'dcat.admin.api.pages.block-registry', 'dcat.admin.api.pages.block.schema-fields', 'minify.assets', 'dcat.admin.', 'dcat.admin.',
        'dcat.admin.', 'dcat.admin.', 'dcat.admin.api.files.upload', 'dcat.admin.', 'dcat.admin.',
        'dcat.admin.', 'login', 'login.store', 'logout', 'password.request',
        ...
        'two-factor.recovery-codes', 'profile.show', 'api-tokens.index', 'teams.create',
        'teams.show', 'current-team.update', 'team-invitations.accept', 'sanctum.csrf-cookie', 'livewire.update', 'livewire.upload-file', 'livewire.preview-file', 'file.public.assets', 'book', 'file.public.storage',
        'dashboard', 'member.register', 'member.', 'member.login', 'member.',
        'member.password.request', 'member.password.email', 'member.password.reset', 'member.password.update', 'member.verification.notice',
        'member.verification.verify', 'member.verification.send', 'member.password.confirm', 'member.', 'member.logout',
        'routes', 'routes', 'home', 'pages.show', 'storage.local', );
    registerArgumentsSet('views',
        ...
        'layouts.guest', 'layouts.public', 'livewire.article-list', 'livewire.article-list', 'livewire.bootstrap',
        'livewire.bootstrap', 'livewire.dynamic-form', 'livewire.dynamic-form', 'livewire.dynamic-form-content', 'livewire.dynamic-form-content',
        'livewire.feature', 'livewire.feature', 'livewire.footer', 'livewire.footer', 'livewire.header',
        'livewire.header', 'livewire.hero-banner', 'livewire.hero-banner', 'livewire.media-slider', 'livewire.media-slider',
        'livewire.specifications', 'livewire.specifications', 'livewire.store-locations', 'livewire.store-locations', 'livewire.testimonial',
        'livewire.testimonial', 'livewire.text-document', 'livewire.text-document', 'livewire.transition-section', 'livewire.transition-section',
        'livewire.video-showcase', 'livewire.video-showcase', 'navigation-menu', 'page-builder::grapes', 'page-builder::index',
        'pages.show', 'pagination::bootstrap-4', 'pagination::bootstrap-5', 'pagination::default', 'pagination::semantic-ui',
        ...
        'teams.show', 'teams.team-member-manager', 'teams.update-team-name-form', 'terms', 'vendor.pagination.bootstrap-4',
        ...
        'vendor.pagination.simple-default', 'vendor.pagination.simple-tailwind', 'vendor.pagination.tailwind', 'admin::dashboard.dependencies', 'admin::dashboard.environment',
        'admin::dashboard.extensions', 'admin::dashboard.title', 'admin::filter.between', 'admin::filter.between-datetime', 'admin::filter.button',
        'admin::filter.checkbox', 'admin::filter.container', 'admin::filter.datetime', 'admin::filter.gt', 'admin::filter.lt',
        'admin::filter.multipleselect', 'admin::filter.radio', 'admin::filter.right-side-container', 'admin::filter.select', 'admin::filter.selecttable',
        'admin::filter.simple-container', 'admin::filter.text', 'admin::filter.where', 'admin::form.autocomplete', 'admin::form.button',
        'admin::form.captcha', 'admin::form.checkbox', 'admin::form.color', 'admin::form.container', 'admin::form.daterange',
        'admin::form.datetimerange', 'admin::form.display', 'admin::form.editor', 'admin::form.embeds', 'admin::form.error',
        'admin::form.fields', 'admin::form.file', 'admin::form.footer', 'admin::form.hasmany', 'admin::form.hasmanytab',
        'admin::form.hasmanytable', 'admin::form.help-block', 'admin::form.hidden', 'admin::form.id', 'admin::form.input',
        'admin::form.keyvalue', 'admin::form.listbox', 'admin::form.listfield', 'admin::form.map', 'admin::form.markdown',
        'admin::form.multipleselect', 'admin::form.number', 'admin::form.radio', 'admin::form.range', 'admin::form.rate',
        'admin::form.row', 'admin::form.select', 'admin::form.select-script', 'admin::form.selecttable', 'admin::form.slider',
        'admin::form.switchfield', 'admin::form.tab', 'admin::form.tags', 'admin::form.textarea', 'admin::form.timerange',
        'admin::form.tree', 'admin::grid.async-fixed-table', 'admin::grid.async-table', 'admin::grid.batch-actions', 'admin::grid.column-selector',
        'admin::grid.displayer.dialogtree', 'admin::grid.displayer.editinline.checkbox', 'admin::grid.displayer.editinline.input', 'admin::grid.displayer.editinline.radio', 'admin::grid.displayer.editinline.template',
        'admin::grid.displayer.editinline.textarea', 'admin::grid.displayer.expand', 'admin::grid.displayer.extensions.description', 'admin::grid.displayer.extensions.name', 'admin::grid.displayer.select',
        'admin::grid.displayer.switch', 'admin::grid.displayer.switchgroup', 'admin::grid.displayer.table', 'admin::grid.dropdown-actions', 'admin::grid.fixed-table',
        'admin::grid.image', 'admin::grid.pagination', 'admin::grid.quick-create.date', 'admin::grid.quick-create.form', 'admin::grid.quick-create.multipleselect',
        'admin::grid.quick-create.select', 'admin::grid.quick-create.selectresource', 'admin::grid.quick-create.tags', 'admin::grid.quick-create.text', 'admin::grid.quick-search',
        'admin::grid.selector', 'admin::grid.table', 'admin::grid.table-pagination', 'admin::grid.table-toolbar', 'admin::helpers.feather',
        'admin::helpers.font-awesome', 'admin::helpers.scaffold', 'admin::layouts.container', 'admin::layouts.content', 'admin::layouts.form-content',
        'admin::layouts.full-content', 'admin::layouts.full-page', 'admin::layouts.page', 'admin::pages.login', 'admin::partials.alerts',
        'admin::partials.breadcrumb', 'admin::partials.exception', 'admin::partials.menu', 'admin::partials.navbar', 'admin::partials.navbar-user-panel',
        'admin::partials.sidebar', 'admin::partials.sidebar-user-panel', 'admin::partials.toastr', 'admin::scripts.select', 'admin::show.container',
        'admin::show.field', 'admin::show.panel', 'admin::show.row', 'admin::tree.branch', 'admin::tree.container',
        'admin::widgets.alert', 'admin::widgets.box', 'admin::widgets.card', 'admin::widgets.checkbox', 'admin::widgets.data-card',
        'admin::widgets.data-card.chart', 'admin::widgets.data-card.line-chart', 'admin::widgets.dialogtable', 'admin::widgets.dropdown', 'admin::widgets.form',
        'admin::widgets.markdown', 'admin::widgets.metrics.card', 'admin::widgets.radio', 'admin::widgets.tab', 'admin::widgets.table',
        'admin::widgets.tree', 'ghost.dcat-config::tree', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context', 'laravel-exceptions-renderer::components.editor',
