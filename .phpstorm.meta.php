...
namespace PHPSTORM_META {
    ...
    override(\config(), map([
        ...
        'appsolutely.blocks.App\Livewire\ArticleList'                 => 'array',
    ...
    registerArgumentsSet('configs',
        ...
        'appsolutely.blocks.App\\Livewire\\ArticleList', 'auth.defaults.guard', 'auth.defaults.passwords', 'auth.guards.web.driver', 'auth.guards.web.provider',
        ...
        'auth.passwords.users.expire', 'auth.passwords.users.throttle', 'auth.password_timeout', 'auth.enable', 'auth.controller',
        'auth.guard', 'auth.remember', 'auth.except', 'auth.enable_session_middleware', 'cache.default',
        ...
        'filesystems.disks.s3.prefix', 'filesystems.links./var/www/appsolute.ly/site/public/storage', 'fortify.guard', 'fortify.middleware', 'fortify.auth_middleware',
        ...
        'ide-helper.post_migrate', 'ide-helper.macroable_traits', 'jetstream.stack', 'jetstream.middleware', 'jetstream.features',
        ...
        'laravellocalization.supportedLocales.en.native', 'laravellocalization.supportedLocales.en.regional', 'laravellocalization.supportedLocales.zh_CN.name', 'laravellocalization.supportedLocales.zh_CN.script', 'laravellocalization.supportedLocales.zh_CN.native',
        'laravellocalization.supportedLocales.zh_CN.regional', 'laravellocalization.supportedLocales.zh-TW.name', 'laravellocalization.supportedLocales.zh-TW.script', 'laravellocalization.supportedLocales.zh-TW.native', 'laravellocalization.supportedLocales.zh-TW.regional',
        ...
        'laravellocalization.urlsIgnored', 'laravellocalization.httpMethodsIgnored', 'livewire.class_namespace', 'livewire.view_path', 'livewire.layout',
        ...
        'queue.failed.table', 'repository.pagination.limit', 'repository.fractal.params.include', 'repository.fractal.serializer', 'repository.cache.enabled',
        'repository.cache.minutes', 'repository.cache.repository', 'repository.cache.clean.enabled', 'repository.cache.clean.on.create', 'repository.cache.clean.on.update',
        'repository.cache.clean.on.delete', 'repository.cache.params.skipCache', 'repository.cache.allowed.only', 'repository.cache.allowed.except', 'repository.criteria.acceptedConditions',
        'repository.criteria.params.search', 'repository.criteria.params.searchFields', 'repository.criteria.params.filter', 'repository.criteria.params.orderBy', 'repository.criteria.params.sortedBy',
        'repository.criteria.params.with', 'repository.criteria.params.searchJoin', 'repository.criteria.params.withCount', 'repository.generator.basePath', 'repository.generator.rootNamespace',
        'repository.generator.stubsOverridePath', 'repository.generator.paths.models', 'repository.generator.paths.repositories', 'repository.generator.paths.interfaces', 'repository.generator.paths.transformers',
        'repository.generator.paths.presenters', 'repository.generator.paths.validators', 'repository.generator.paths.controllers', 'repository.generator.paths.provider', 'repository.generator.paths.criteria',
        ...
        'services.ses.secret', 'services.ses.region', 'services.slack.notifications.bot_user_oauth_token', 'services.slack.notifications.channel', 'services.translation.provider',
        'services.translation.openai.api_key', 'services.translation.openai.model', 'services.translation.openai.max_tokens', 'services.translation.openai.temperature', 'services.translation.deepseek.api_key',
        'services.translation.deepseek.model', 'services.translation.deepseek.max_tokens', 'services.translation.deepseek.temperature', 'session.driver', 'session.lifetime',
        ...
        'session.secure', 'session.http_only', 'session.same_site', 'session.partitioned', 'theme.active',
        'theme.parent', 'theme.base_path', 'hashing.driver', 'hashing.bcrypt.rounds', 'hashing.bcrypt.verify',
        ...
        'cors.max_age', 'cors.supports_credentials', 'eloquent-sortable.order_column_name', 'eloquent-sortable.sort_when_creating', 'eloquent-sortable.ignore_timestamps',
        ...
        'responsecache.replacers', 'responsecache.cache_tag', 'responsecache.hasher', 'responsecache.serializer', 'tinker.commands',
    ...
    registerArgumentsSet('views',
        ...
        'layouts.guest', 'layouts.public', 'livewire.article-list', 'livewire.article-list', 'livewire.article-list.detail',
        'livewire.article-list.detail', 'livewire.article-list.list', 'livewire.article-list.list', 'livewire.dynamic-form', 'livewire.dynamic-form',
        'livewire.dynamic-form-content', 'livewire.dynamic-form-content', 'livewire.feature', 'livewire.feature', 'livewire.footer',
        'livewire.footer', 'livewire.header', 'livewire.header', 'livewire.hero-banner', 'livewire.hero-banner',
        'livewire.media-slider', 'livewire.media-slider', 'livewire.specifications', 'livewire.specifications', 'livewire.store-locations',
        'livewire.store-locations', 'livewire.testimonial', 'livewire.testimonial', 'livewire.text-document', 'livewire.text-document',
        'livewire.transition-section', 'livewire.transition-section', 'livewire.video-showcase', 'livewire.video-showcase', 'livewire::bootstrap',
        'livewire::simple-bootstrap', 'livewire::simple-tailwind', 'livewire::tailwind', 'navigation-menu', 'page-builder::grapes',
        'page-builder::index', 'pages.show', 'pagination.bootstrap', 'pagination.bootstrap', 'pagination::bootstrap-4',
        ...
        'pagination::simple-default', 'pagination::simple-tailwind', 'pagination::tailwind', 'policy', 'profile.delete-user-form',
        ...
        'teams.create', 'teams.create-team-form', 'teams.delete-team-form', 'teams.show', 'teams.team-member-manager',
        'teams.update-team-name-form', 'terms', 'vendor.livewire.bootstrap', 'vendor.livewire.simple-bootstrap', 'vendor.livewire.simple-tailwind',
        'vendor.livewire.tailwind', 'vendor.pagination.bootstrap-4', 'vendor.pagination.bootstrap-5', 'vendor.pagination.default', 'vendor.pagination.semantic-ui',
        ...
        'admin::dashboard.dependencies', 'admin::dashboard.environment', 'admin::dashboard.extensions', 'admin::dashboard.title', 'admin::filter.between',
        'admin::filter.between-datetime', 'admin::filter.button', 'admin::filter.checkbox', 'admin::filter.container', 'admin::filter.datetime',
        'admin::filter.gt', 'admin::filter.lt', 'admin::filter.multipleselect', 'admin::filter.radio', 'admin::filter.right-side-container',
        'admin::filter.select', 'admin::filter.selecttable', 'admin::filter.simple-container', 'admin::filter.text', 'admin::filter.where',
        'admin::form.autocomplete', 'admin::form.button', 'admin::form.captcha', 'admin::form.checkbox', 'admin::form.color',
        'admin::form.container', 'admin::form.daterange', 'admin::form.datetimerange', 'admin::form.display', 'admin::form.editor',
        'admin::form.embeds', 'admin::form.error', 'admin::form.fields', 'admin::form.file', 'admin::form.footer',
        'admin::form.hasmany', 'admin::form.hasmanytab', 'admin::form.hasmanytable', 'admin::form.help-block', 'admin::form.hidden',
        'admin::form.id', 'admin::form.input', 'admin::form.keyvalue', 'admin::form.listbox', 'admin::form.listfield',
        'admin::form.map', 'admin::form.markdown', 'admin::form.multipleselect', 'admin::form.number', 'admin::form.radio',
        'admin::form.range', 'admin::form.rate', 'admin::form.row', 'admin::form.select', 'admin::form.select-script',
        'admin::form.selecttable', 'admin::form.slider', 'admin::form.switchfield', 'admin::form.tab', 'admin::form.tags',
        'admin::form.textarea', 'admin::form.timerange', 'admin::form.tree', 'admin::grid.async-fixed-table', 'admin::grid.async-table',
        'admin::grid.batch-actions', 'admin::grid.column-selector', 'admin::grid.displayer.dialogtree', 'admin::grid.displayer.editinline.checkbox', 'admin::grid.displayer.editinline.input',
        'admin::grid.displayer.editinline.radio', 'admin::grid.displayer.editinline.template', 'admin::grid.displayer.editinline.textarea', 'admin::grid.displayer.expand', 'admin::grid.displayer.extensions.description',
        'admin::grid.displayer.extensions.name', 'admin::grid.displayer.select', 'admin::grid.displayer.switch', 'admin::grid.displayer.switchgroup', 'admin::grid.displayer.table',
        'admin::grid.dropdown-actions', 'admin::grid.fixed-table', 'admin::grid.image', 'admin::grid.pagination', 'admin::grid.quick-create.date',
        'admin::grid.quick-create.form', 'admin::grid.quick-create.multipleselect', 'admin::grid.quick-create.select', 'admin::grid.quick-create.selectresource', 'admin::grid.quick-create.tags',
        'admin::grid.quick-create.text', 'admin::grid.quick-search', 'admin::grid.selector', 'admin::grid.table', 'admin::grid.table-pagination',
        'admin::grid.table-toolbar', 'admin::helpers.feather', 'admin::helpers.font-awesome', 'admin::helpers.scaffold', 'admin::layouts.container',
        'admin::layouts.content', 'admin::layouts.form-content', 'admin::layouts.full-content', 'admin::layouts.full-page', 'admin::layouts.page',
        'admin::pages.login', 'admin::partials.alerts', 'admin::partials.breadcrumb', 'admin::partials.exception', 'admin::partials.menu',
        'admin::partials.navbar', 'admin::partials.navbar-user-panel', 'admin::partials.sidebar', 'admin::partials.sidebar-user-panel', 'admin::partials.toastr',
        'admin::scripts.select', 'admin::show.container', 'admin::show.field', 'admin::show.panel', 'admin::show.row',
        'admin::tree.branch', 'admin::tree.container', 'admin::widgets.alert', 'admin::widgets.box', 'admin::widgets.card',
        'admin::widgets.checkbox', 'admin::widgets.data-card', 'admin::widgets.data-card.chart', 'admin::widgets.data-card.line-chart', 'admin::widgets.dialogtable',
        'admin::widgets.dropdown', 'admin::widgets.form', 'admin::widgets.markdown', 'admin::widgets.metrics.card', 'admin::widgets.radio',
        'admin::widgets.tab', 'admin::widgets.table', 'admin::widgets.tree', 'ghost.dcat-config::tree', 'laravel-exceptions-renderer::components.card',
