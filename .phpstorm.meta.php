...
namespace PHPSTORM_META {
    ...
    override(\config(), map([
        ...
        'filesystems.links./Users/chum/Documents/Projects/appsolute.ly/site/public/storage' => 'string',
    ...
    registerArgumentsSet('configs',
        ...
        'filesystems.disks.s3.report', 'filesystems.disks.s3.prefix', 'filesystems.links./Users/chum/Documents/Projects/appsolute.ly/site/public/storage', 'fortify.guard', 'fortify.middleware',
    ...
    registerArgumentsSet('routes',
        ...
        'dcat.admin.file.self', 'dcat.admin.articles.index', 'dcat.admin.articles.create', 'dcat.admin.articles.store', 'dcat.admin.articles.show',
        'dcat.admin.articles.edit', 'dcat.admin.articles.update', 'dcat.admin.articles.destroy', 'dcat.admin.articles.categories.index', 'dcat.admin.articles.categories.create',
        ...
        'dcat.admin.pages.index', 'dcat.admin.pages.create', 'dcat.admin.pages.store', 'dcat.admin.pages.show', 'dcat.admin.pages.edit',
        'dcat.admin.pages.update', 'dcat.admin.pages.destroy', 'dcat.admin.pages.design', 'dcat.admin.pages.block-settings.index', 'dcat.admin.pages.block-settings.create',
        ...
        'dcat.admin.pages.block-groups.show', 'dcat.admin.pages.block-groups.edit', 'dcat.admin.pages.block-groups.update', 'dcat.admin.pages.block-groups.destroy', 'dcat.admin.products.index',
        'dcat.admin.products.create', 'dcat.admin.products.store', 'dcat.admin.products.show', 'dcat.admin.products.edit', 'dcat.admin.products.update',
        'dcat.admin.products.destroy', 'dcat.admin.products.categories.index', 'dcat.admin.products.categories.create', 'dcat.admin.products.categories.store', 'dcat.admin.products.categories.show',
        'dcat.admin.products.categories.edit', 'dcat.admin.products.categories.update', 'dcat.admin.products.categories.destroy', 'dcat.admin.products.skus.index', 'dcat.admin.products.skus.create',
        'dcat.admin.products.skus.store', 'dcat.admin.products.skus.show', 'dcat.admin.products.skus.edit', 'dcat.admin.products.skus.update', 'dcat.admin.products.skus.destroy',
        'dcat.admin.products.attribute-groups.index', 'dcat.admin.products.attribute-groups.create', 'dcat.admin.products.attribute-groups.store', 'dcat.admin.products.attribute-groups.show', 'dcat.admin.products.attribute-groups.edit',
        'dcat.admin.products.attribute-groups.update', 'dcat.admin.products.attribute-groups.destroy', 'dcat.admin.products.attributes.index', 'dcat.admin.products.attributes.create', 'dcat.admin.products.attributes.store',
        'dcat.admin.products.attributes.show', 'dcat.admin.products.attributes.edit', 'dcat.admin.products.attributes.update', 'dcat.admin.products.attributes.destroy', 'dcat.admin.products.attribute-values.index',
        'dcat.admin.products.attribute-values.create', 'dcat.admin.products.attribute-values.store', 'dcat.admin.products.attribute-values.show', 'dcat.admin.products.attribute-values.edit', 'dcat.admin.products.attribute-values.update',
        'dcat.admin.products.attribute-values.destroy', 'dcat.admin.orders.index', 'dcat.admin.orders.create', 'dcat.admin.orders.store', 'dcat.admin.orders.show',
        'dcat.admin.orders.edit', 'dcat.admin.orders.update', 'dcat.admin.orders.destroy', 'dcat.admin.releases.builds.index', 'dcat.admin.releases.builds.create',
        'dcat.admin.releases.builds.store', 'dcat.admin.releases.builds.show', 'dcat.admin.releases.builds.edit', 'dcat.admin.releases.builds.update', 'dcat.admin.releases.builds.destroy',
        'dcat.admin.releases.versions.index', 'dcat.admin.releases.versions.create', 'dcat.admin.releases.versions.store', 'dcat.admin.releases.versions.show', 'dcat.admin.releases.versions.edit',
        'dcat.admin.releases.versions.update', 'dcat.admin.releases.versions.destroy', 'dcat.admin.api.file-library', 'dcat.admin.api.common.quick-edit', 'dcat.admin.api.attribute-groups',
        'dcat.admin.api.pages.data', 'dcat.admin.api.pages.save', 'dcat.admin.api.pages.blocks.registry', 'minify.assets', 'login',
        ...
        'terms.show', 'policy.show', 'profile.show', 'api-tokens.index', 'teams.create',
        'teams.show', 'current-team.update', 'team-invitations.accept', 'sanctum.csrf-cookie', 'livewire.update', 'livewire.upload-file', 'livewire.preview-file', 'file.public.assets', 'file.public.storage', 'dashboard',
        ...
        'routes', 'pages.show', 'storage.local', );
    registerArgumentsSet('views',
        ...
        'layouts.guest', 'navigation-menu', 'page-builder::grapes', 'page-builder::index', 'pages.show',
        ...
        'admin::widgets.table', 'admin::widgets.tree', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context', 'laravel-exceptions-renderer::components.editor',
