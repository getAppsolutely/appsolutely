...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.s3.prefix','filesystems.links./var/www/appsolute.ly/site/public/storage',
...
'jetstream.guard','laravellocalization.supportedLocales.en.name','laravellocalization.supportedLocales.en.script','laravellocalization.supportedLocales.en.native','laravellocalization.supportedLocales.en.regional',
'laravellocalization.supportedLocales.zh.name','laravellocalization.supportedLocales.zh.script','laravellocalization.supportedLocales.zh.native','laravellocalization.supportedLocales.zh.regional','laravellocalization.useAcceptLanguageHeader',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','theme.active',
'theme.parent','theme.base_path','eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps',
...
'dcat.admin.','dcat.admin.','dcat.admin.','dcat.admin.file.retrieve','dcat.admin.',
'dcat.admin.files.index','dcat.admin.files.create','dcat.admin.files.store','dcat.admin.files.show','dcat.admin.files.edit',
'dcat.admin.files.update','dcat.admin.files.destroy','minify.assets','dcat.admin.','dcat.admin.',
'dcat.admin.','dcat.admin.','dcat.admin.','dcat.admin.','dcat.admin.',
...
'terms','welcome','admin::dashboard.dependencies','admin::dashboard.environment','admin::dashboard.extensions',
'admin::dashboard.title','admin::filter.between','admin::filter.between-datetime','admin::filter.button','admin::filter.checkbox',
'admin::filter.container','admin::filter.datetime','admin::filter.gt','admin::filter.lt','admin::filter.multipleselect',
'admin::filter.radio','admin::filter.right-side-container','admin::filter.select','admin::filter.selecttable','admin::filter.simple-container',
'admin::filter.text','admin::filter.where','admin::form.autocomplete','admin::form.button','admin::form.captcha',
'admin::form.checkbox','admin::form.color','admin::form.container','admin::form.daterange','admin::form.datetimerange',
'admin::form.display','admin::form.editor','admin::form.embeds','admin::form.error','admin::form.fields',
'admin::form.file','admin::form.footer','admin::form.hasmany','admin::form.hasmanytab','admin::form.hasmanytable',
'admin::form.help-block','admin::form.hidden','admin::form.id','admin::form.input','admin::form.keyvalue',
'admin::form.listbox','admin::form.listfield','admin::form.map','admin::form.markdown','admin::form.multipleselect',
'admin::form.number','admin::form.radio','admin::form.range','admin::form.rate','admin::form.row',
'admin::form.select','admin::form.select-script','admin::form.selecttable','admin::form.slider','admin::form.switchfield',
'admin::form.tab','admin::form.tags','admin::form.textarea','admin::form.timerange','admin::form.tree',
'admin::grid.async-fixed-table','admin::grid.async-table','admin::grid.batch-actions','admin::grid.column-selector','admin::grid.displayer.dialogtree',
'admin::grid.displayer.editinline.checkbox','admin::grid.displayer.editinline.input','admin::grid.displayer.editinline.radio','admin::grid.displayer.editinline.template','admin::grid.displayer.editinline.textarea',
'admin::grid.displayer.expand','admin::grid.displayer.extensions.description','admin::grid.displayer.extensions.name','admin::grid.displayer.select','admin::grid.displayer.switch',
'admin::grid.displayer.switchgroup','admin::grid.displayer.table','admin::grid.dropdown-actions','admin::grid.fixed-table','admin::grid.image',
'admin::grid.pagination','admin::grid.quick-create.date','admin::grid.quick-create.form','admin::grid.quick-create.multipleselect','admin::grid.quick-create.select',
'admin::grid.quick-create.selectresource','admin::grid.quick-create.tags','admin::grid.quick-create.text','admin::grid.quick-search','admin::grid.selector',
'admin::grid.table','admin::grid.table-pagination','admin::grid.table-toolbar','admin::helpers.feather','admin::helpers.font-awesome',
'admin::helpers.scaffold','admin::layouts.container','admin::layouts.content','admin::layouts.form-content','admin::layouts.full-content',
'admin::layouts.full-page','admin::layouts.page','admin::pages.login','admin::partials.alerts','admin::partials.breadcrumb',
'admin::partials.exception','admin::partials.menu','admin::partials.navbar','admin::partials.navbar-user-panel','admin::partials.sidebar',
'admin::partials.sidebar-user-panel','admin::partials.toastr','admin::scripts.select','admin::show.container','admin::show.field',
'admin::show.panel','admin::show.row','admin::tree.branch','admin::tree.container','admin::widgets.alert',
'admin::widgets.box','admin::widgets.card','admin::widgets.checkbox','admin::widgets.data-card','admin::widgets.data-card.chart',
'admin::widgets.data-card.line-chart','admin::widgets.dialogtable','admin::widgets.dropdown','admin::widgets.form','admin::widgets.markdown',
'admin::widgets.metrics.card','admin::widgets.radio','admin::widgets.tab','admin::widgets.table','admin::widgets.tree',
'ghost.dcat-config::tree','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'AWS_USE_PATH_STYLE_ENDPOINT','AWS_PREFIX','VITE_APP_NAME','MINIFY_ENABLED','TRANSLATION_PROVIDER',
'TRANSLATION_JOB_LIMIT','AUTO_TRANSLATION_ENABLED','OPENAI_API_KEY','OPENAI_MODEL','DEEPSEEK_API_KEY',
'DEEPSEEK_MODEL',);
